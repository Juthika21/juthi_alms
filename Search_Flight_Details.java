...
public class Search_Flight_Details extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(348, 18, -1, 46));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Source:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 71, -1, 39));
        ...
        getContentPane().add(txtsource, new org.netbeans.lib.awtextra.AbsoluteConstraints(85, 72, 133, 39));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Destination:");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 70, 120, 39));
        ...
        getContentPane().add(txtdestination, new org.netbeans.lib.awtextra.AbsoluteConstraints(348, 72, 137, 39));
        ...
        getContentPane().add(search_flight, new org.netbeans.lib.awtextra.AbsoluteConstraints(795, 71, -1, 42));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(44, 152, 830, 363));
        getContentPane().add(Date, new org.netbeans.lib.awtextra.AbsoluteConstraints(597, 71, 138, 42));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Date:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(516, 72, 63, 41));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Flight Id:");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 131, 109, 34));
        getContentPane().add(fid, new org.netbeans.lib.awtextra.AbsoluteConstraints(1106, 131, 200, 34));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Flight Name:");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 183, 160, 34));
        getContentPane().add(fname, new org.netbeans.lib.awtextra.AbsoluteConstraints(1106, 183, 200, 34));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Source:");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 235, 109, 34));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Destination:");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 287, 160, 34));
        getContentPane().add(source, new org.netbeans.lib.awtextra.AbsoluteConstraints(1106, 235, 200, 34));
        getContentPane().add(dest, new org.netbeans.lib.awtextra.AbsoluteConstraints(1106, 287, 200, 34));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Date:");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 345, 109, 34));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Arrival Time:");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 410, 150, -1));
        getContentPane().add(atime, new org.netbeans.lib.awtextra.AbsoluteConstraints(1106, 397, 200, 34));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Departure Time:");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(937, 441, -1, 34));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Price:");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(937, 492, -1, 34));
        getContentPane().add(dtime, new org.netbeans.lib.awtextra.AbsoluteConstraints(1106, 441, 200, 34));
        getContentPane().add(fprice, new org.netbeans.lib.awtextra.AbsoluteConstraints(993, 493, 56, 34));
        getContentPane().add(Date1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1106, 345, 200, 34));

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Customer Name:");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(937, 601, -1, 34));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Ticket No:");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 75, 109, 34));
        getContentPane().add(tno, new org.netbeans.lib.awtextra.AbsoluteConstraints(1106, 71, 200, 34));

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("Seats:");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(937, 548, 112, 34));
        ...
        getContentPane().add(seats, new org.netbeans.lib.awtextra.AbsoluteConstraints(1106, 549, 200, 34));
        getContentPane().add(tarea, new org.netbeans.lib.awtextra.AbsoluteConstraints(1106, 601, 200, 62));
        ...
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(1106, 492, -1, 34));
        getContentPane().add(tprice, new org.netbeans.lib.awtextra.AbsoluteConstraints(1210, 493, 96, 34));

        jLabel17.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("Ticket Booking Form");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 20, 300, 39));
        ...
        jLabel18.setIcon(new javax.swing.ImageIcon("C:\\Users\\Senthil Kumar\\OneDrive\\Pictures\\javapics\\PIC2.png")); // NOI18N
        getContentPane().add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(-1, -5, 1410, 770));
